...
// Sensor IDs
#define ACCSENSORID                (0x8700A)
#define MAGSENSORID                (0x8700B)
...
class FXOS8700: public Adafruit_Sensor {
  public:
    FXOS8700();
    FXOS8700(int32_t accelSensorID, int32_t magSensorID);
    ~FXOS8700();

    bool begin(fxos8700AccelRange_t rng, i2c_bus &common_bus);
